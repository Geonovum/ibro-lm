...
| &nbsp;&nbsp; `geregistreerdMet / beginGprimaireBroneldigheid`          | -                                                         |                                       |
...
| &nbsp;&nbsp; `^isOnderdeeVan` **Panddeel**        | &nbsp;&nbsp; `buildingPart` of `buildingInstallation`               | Binnenkomende relaties `isOnderdeelVan` worden omgezet naar `buildingPart` of `buildingInstallation` relaties afhankelijk van het type Panddeel (zie hieronder).                    |
...
| **Panddeel**  `type = Basisconstructie`           | **BuildingPart** `type = Basisconstructie`                          |                                                                                                                                                                                     |
| **Panddeel**  `type = LatereAanbouw`              | **BuildingPart** `type = LatereAanbouw`                             |                                                                                                                                                                                     |
| **Panddeel**  `type = Serre`                      | **BuildingPart**  `type = Serre`                                    |                                                                                                                                                                                     |
